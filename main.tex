...
\begin{subfigure}{0.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{figures/analysis_7_smatt_betas.png}
  \caption{}
  \label{fig:sfig1}
\end{subfigure}
