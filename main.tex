...
\begin{subfigure}{1\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{PCA_3PCs_age_sex_regressed_hcpaging_hcpya_raw.pdf}
  \caption{First three PCs of unharmonized HCP data after regressing out age and sex.}
  \label{fig:sfig1}
\end{subfigure}
\begin{subfigure}{1\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{PCA_3PCs_age_sex_regressed_hcpaging_hcpya_ComBat.pdf}
