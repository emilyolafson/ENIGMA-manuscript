...
\begin{subfigure}{0.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{figures/fs86subj_normed_motor_scores_chacovol_chronic_ridge_crossval1_meanfeatureweight_allperms_50_surfaces_fig.png}
  \caption{}
  \label{fig:sfig1}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{figures/shen268_normed_motor_scores_chacovol_chronic_ridge_crossval1_meanfeatureweight_allperms_50_surfaces_fig.png}
  \caption{}
  \label{fig:sfig1}
\end{subfigure}
\begin{subfigure}{1\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{figures/fs86subj_normed_motor_scores_chacovol_chronic_ridge_crossval1_meanfeatureweight_allperms_50_subcortical_fig.png}
  \caption{}
  \label{fig:sfig1}
\end{subfigure}
\begin{subfigure}{1\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{figures/shen268_normed_motor_scores_chacovol_chronic_ridge_crossval1_meanfeatureweight_allperms_50_subcortical_fig.png}
  \caption{}
  \label{fig:sfig1}
\end{subfigure}
\caption{Analysis 1}
