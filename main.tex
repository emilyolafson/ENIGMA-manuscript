...
\begin{table}[h]
\centering
\caption{Demographics for ENIGMA Stroke Recovery Working Group participants included in the training set by site}
...
r005 & 28 (12/16) & 65.5 (18.5) & 0.78 (0.50) & 27.5 (25.9) & 1.65 (29.15) \\
r009 & 110 (30/80) & 70.0 (9.0) & 1.00 (0.09) & 14.5 (27.3) & 1.55 (5.94) \\
r025 & 25 (7/18) & 66.0 (19.0) & 0.98 (0.20) & 10.2 (13.2) & 2.64 (8.36) \\
r027 & 28 (8/20) & 57.0 (10.2) & 0.30 (0.16) & 19.3 (24.7) & 12.30 (62.13) \\
r028 & 22 (6/16) & 63.0 (8.5) & 0.81 (0.23) & 24.5 (37.6) & 7.00 (41.07) \\
r031 & 37 (10/27) & 58.0 (13.0) & 0.52 (0.38) & 4.6 (1.7) & 9.61 (37.54) \\
r034 & 15 (6/9) & 58.4 (11.1) & 0.82 (0.20) & 61.3 (68.3) & 6.68 (34.99) \\
r035 & 15 (6/9) & 64.0 (18.0) & 0.64 (0.52) & 33.5 (22.9) & 3.89 (31.56) \\
r038 & 90 (37/53) & 67.0 (21.0) & 0.85 (0.64) & 3.4 (3.7) & 5.98 (30.30) \\
r040 & 71 (39/32) & 64.0 (20.0) & 0.45 (0.53) & 2.3 (2.4) & 11.94 (64.57) \\
...
r047 & 46 (15/31) & 66.0 (11.8) & 0.65 (0.45) & 34.1 (52.4) & 12.72 (39.81) \\
...
r053 & 54 (21/33) & 63.5 (19.5) & 0.90 (0.18) & 3.0 (3.1) & 14.29 (28.85) \\
r054 & 12 (5/7) & 65.5 (11.8) & 0.67 (0.83) & 0.4 (0.2) & 4.06 (14.15) \\
\arrayrulecolor{black!30}\midrule
All sites & 789 (293/496) & 64.0 (18.0) & 0.7 (0.5) & 12.2 (0.2) & 6.45 (32.48) \\
\bottomrule
\end{tabular}
\caption*{Site breakdown of total sample size (N), number of females (F) and males (M), and information about age (years), normed motor scores, and time since stroke (days). IQR, interquartile range}
\end{table}
...
\centering
\label{table:5}
\caption{Demographics for ENIGMA Stroke Recovery Working Group participants included in the test groups by site}
...
\multirow[t]{5}{*}{Demographics} & M1 CST LL $\Plus$ demog. & 0.437 (0.006) & 0.167 (0.004) \\
...
\multirow[t]{6}{*}{Lesion load} & M1 CST LL $\Plus$ ChaCo (fs86) & 0.460 (0.007) & 0.199 (0.006) \\
 plus ChaCo & Ipsi. SMATT LL $\Plus$ ChaCo (fs86) & 0.470 (0.008) & 0.213 (0.006) \\
...
\multirow[t]{6}{*}{Lesion load} & M1 CST LL $\Plus$ ChaCo  (fs86) $\Plus$ demog. & 0.481 (0.007) & 0.196 (0.004) \\
 plus ChaCo & Ipsi. SMATT LL $\Plus$ ChaCo  (fs86) $\Plus$ demog. & 0.490 (0.007) & 0.208 (0.005) \\
 plus demographics & L/R SMATT LL $\Plus$ ChaCo  (fs86) $\Plus$ demog. & 0.492 (0.008) & 0.208 (0.006) \\
