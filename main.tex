...
\begin{figure}[htp]
\centering
\includegraphics[width=1\linewidth]{all_sLNM_copy.png}
\caption{Structural lesion-network map principal components, split into separate positive and negative voxels relative to an MNI template.}
\label{M1}
\end{figure}
\begin{figure}[htp]
\centering
...
\subsubsection*{Lesion-behavior map models}
