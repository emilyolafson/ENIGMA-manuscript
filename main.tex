...
\begin{figure}[htp]
\centering
\includegraphics[width=0.5\linewidth]{figures/analysis_11_smatt_featureimpt.png}
\caption{Sensorimotor area tract template feature importance. Includes primary motor cortex (M1), dorsal premotor cortex (PMd), ventral premotor cortex (PMv), supplementary motor area (SMA), pre-supplementary motor area (pre-SMA), primary sensory cortex (S1).
}
\label{smatt_template}
\end{figure} 
...
\begin{subfigure}{0.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{figures/analysis_11_smatt_featureimpt.pdf}
  \caption{}
  \label{fig:sfig1}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
