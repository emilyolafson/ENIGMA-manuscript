...
The features selected in the Shen268 ChaCo models \ref{heatmap_shen}
...
\caption{Sum of ChaCo scores for then shen268 atlas for acute (\textbf{A}) and chronic (\textbf{B}) subjects.}
\label{smatt_pairwise_correlations}
\end{figure}
