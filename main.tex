...
\begin{figure}[htp]
\centering
\includegraphics[width=1\linewidth]{figures/M1.png}
\caption{M1 displaying only right hemisphere tracts relative to an MNI template, including  primary motor cortex (M1)}
\label{M1}
\end{figure}
